            ...
            <div className="flex items-start gap-4 p-6 bg-card/90 backdrop-blur-sm rounded-2xl border border-border max-w-2xl mb-8">
              ...
              <div>
                <p className="text-lg text-foreground leading-relaxed">
                  ...
                  Our mission is to make <strong>high-quality AI education accessible</strong> to young professionals everywhere.<br />
                  Empowering them to <strong>grow, adapt, and stay relevant</strong> in a fast-changing world.
                </p>
              </div>
            </div>
          </div>

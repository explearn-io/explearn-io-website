  ...
  const onSubmit = async (data: SignupFormData) => {
    ...
    try {
      ...
      const registrationData = {
        ...
        architecture_experience: data.experience.architectureExperience,
        track: data.courseSelection.track,
        format: data.courseSelection.format,
        achievements: data.goals.achievements,
        referral_source: data.goals.referralSource,
        email_consent: data.goals.emailConsent,
      ...
      toast({
        ...
        description: "We'll be in touch soon with your course details.",
      });
